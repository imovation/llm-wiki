...
- [[graphify]] - 多模态代码知识图谱（Leiden 社区 + God Node + 边置信度，v0.9.38）。
...
- [[openwiki]] - LangChain 的 agent 文档 CLI，OKF 兼容，CI 自动更新（v0.3.1）。
- [[openspec]] - 规范驱动开发（SDD）框架，/opsx:propose → apply → archive。
